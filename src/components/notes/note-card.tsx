...
export function NoteCard({ note, from }: NoteCardProps) {
  return (
    <Tilt isRevese>
      <div className="group relative flex h-full flex-col space-y-2 rounded-lg border bg-card p-4 transition-colors hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none">
        <>
